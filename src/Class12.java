 ...
 * @author JATIN
 */
public class Class12 extends javax.swing.JFrame {
Connection con;
ResultSet rs;
Statement stmt;
    /**
     * Creates new form Class12
     */
    public Class12() {
        initComponents();
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(197, 197, 197)
                                .addComponent(check, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void checkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkActionPerformed
        try{Date d=new Date();
            ...
            switch (mon) {
                ...
                JOptionPane.showMessageDialog(null,"Name :"+Name1+". Your attendance is "+countoffinal1+"/"+total+" in the month of "+month+" and you were absent for = "+countoffinal0+" days");
...
c2.requestFocus();
    ...
    t1.setText(""+y);
     Class.forName("com.mysql.jdbc.Driver");
            ...
            stmt=con.createStatement();
            String sql="Select section from batchrgstr where Class=12;";
 rs=stmt.executeQuery(sql);
 while(rs.next())
 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
